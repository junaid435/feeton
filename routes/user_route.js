...
user_route.get('/profile',user_auth.UserisLoginOut,user_controller.loadProfile)
...
user_route.get('/passwordChange',user_auth.UserisLoginOut,user_controller.passwordChange)
//TO change the password 
user_route.post('/changepassword',user_controller.changepassword)
//To load the add Address page 
user_route.get('/addAddress',user_auth.UserisLoginOut,address_controller.loadAddress)
//To create a address
user_route.post('/addAddress',address_controller.addAddress)
// TO load the edit address page 
user_route.get('/edit-address',user_auth.UserisLoginOut,address_controller.loadEditAddress)
//To edit the address 
user_route.post('/edit-address',address_controller.EditAddress)
//To load the cart page 
user_route.get('/cart',user_auth.UserisLoginOut,Cart_controller.loadcart)
//to remove the cart 
user_route.get('/CartRemove',user_auth.UserisLoginOut,Cart_controller.CartRemove)
...
user_route.get('/Proceed',user_auth.UserisLoginOut,Cart_controller.loadProceed)
//to create a order 
...
user_route.get('/order_Placed',user_auth.UserisLoginOut,Order_controller.loadOrderPlaced)
// user logout 
...
user_route.get('/addAddressCart',user_auth.UserisLoginOut,address_controller.loadAddressCart)
...
user_route.get('/wishlist',user_auth.UserisLoginOut,user_controller.loadWishlist)
...
user_route.get('/Order_view',user_auth.UserisLoginOut,Order_controller.loadOrderView)
// To get the invoice of the order 
user_route.get('/invoice',user_auth.UserisLoginOut,user_controller.invoiceDownload)
//To load Wallet History
user_route.get('/walletHistory',user_auth.UserisLoginOut,user_controller.walletHistory)
